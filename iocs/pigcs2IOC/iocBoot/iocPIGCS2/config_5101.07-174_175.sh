...
# Use netcat to send commands
{
  ...
  sleep 1
  echo "SPA 1 0xa 0.600000"
  sleep 1
  echo "ACC 1 1.000000"
  sleep 1
  echo "DEC 1 1.000000"
  sleep 1
  echo "SPA 1 0xe 25755648"
  sleep 1
  echo "SPA 1 0xf 1"
  sleep 1
  echo "SPA 1 0x13 0"
  ...
  echo "SPA 1 0x36 0"
  sleep 1
  echo "SPA 1 0x3c 5101.07-174_175"
  sleep 1 
  ...
  echo "VEL 1 0.500000"
  sleep 1
  echo "SPA 1 0x4a 1.000000"
  sleep 1
  echo "SPA 1 0x4b 1.000000"
  sleep 1
  echo "SPA 1 0x50 0.500000"
  sleep 1
  ...
  sleep 1
  echo "SPA 1 0x7000000 -0.500000"
  sleep 1
  echo "SPA 1 0x7000001 25.500000"
  sleep 1
